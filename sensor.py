...
CONF_SERVER = "server"
CONF_SENDERS_REGEX = "senders_regex"
CONF_FOLDER = "folder"
...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend(
    {
        ...
        vol.Required(CONF_SENDERS_REGEX): [cv.string],
...
class EmailContentSensor(SensorEntity):
    ...
    def __init__(self, hass, email_reader, name, allowed_senders_regex, value_template):
